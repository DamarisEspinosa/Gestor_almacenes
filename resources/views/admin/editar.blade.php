            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('usuarios.update', $usuario->id) }}">
                    ...
                    <div class="grid sm:grid-cols-2 gap-y-7 gap-x-12">
                        <!-- Nombre -->
                        <div class="mb-4">
                            <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Nombre Comercial:</label>
                        ...
                        <!-- RFC -->
                        <div class="mb-4">
                            <label for="rfc" class="block text-gray-700 text-sm font-bold mb-2">Número de identificación fiscal:</label>
